(function (global) {
  ...
  function initReactivePanels() {
    const targets = document.querySelectorAll('.card,.log,.observation,.terminal-panel,.scanner-shell,.console-shell,.archive-shell,.archive-card,.application-card,.test-hero,.test-landing,.test-console,.test-panel,.sender-shell,.buttons a,.scanner-button');
