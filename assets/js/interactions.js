(function (global) {
  ...
  function initReactivePanels() {
    const targets = document.querySelectorAll('.card,.log,.observation,.terminal-panel,.scanner-shell,.console-shell,.archive-shell,.archive-card,.evolution-hero,.evolution-phase,.evolution-tree-shell,.evolution-telemetry,.evolution-terminal-panel,.buttons a,.scanner-button');
